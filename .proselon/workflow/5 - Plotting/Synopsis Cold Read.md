...
1. Give the first **only the opening ~25% of the synopsis** (for a chapter map: the first act's chapter lines). Ask it to predict, concretely: the midpoint turn, the crisis, the climax, and the ending.
2. Give the second the opening **~50%**. Same predictions.
